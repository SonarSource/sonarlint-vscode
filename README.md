...
Check the [SonarLint for VS Code documentation](https://docs.sonarsource.com/sonarlint/vs-code/) for a full list of installation instructions, requirements, and feature details.
