...
suite('AiIntegrationTelemetry', () => {
  ...
  test('sends only allowed action keys and normalizes failure category', () => {
  ...
  test('reports an explicit false Vortex value with named status enums', () => {
    reporter.cliState(AiIntegration.AiIntegrationObservationTrigger.INITIAL_LOAD, {
  ...
  test('deduplicates agents and detection sources and reports unknown for uninspected MCP', () => {
    ...
    reporter.agentStates(AiIntegration.AiIntegrationObservationTrigger.POST_ACTION, [
