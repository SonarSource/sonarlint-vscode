...
* Update Java analyzer 8.36 -> [8.37](https://github.com/SonarSource/sonar-java/releases/tag/8.37.0.45887) -> [8.38](https://github.com/SonarSource/sonar-java/releases/tag/8.38.0.46176)
* Update Python analyzer 5.26 -> [5.27](https://github.com/SonarSource/sonar-python/releases/tag/5.27.0.35548) -> [5.28](https://github.com/SonarSource/sonar-python/releases/tag/5.28.0.35681)
...
* Update Java analyzer 8.29 -> [8.30](https://github.com/SonarSource/sonar-java/releases/tag/8.30.0.43910) -> [8.32](https://github.com/SonarSource/sonar-java/releases/tag/8.32.0.44337) -> [8.32.1](https://github.com/SonarSource/sonar-java/releases/tag/8.32.1.44409) -> [8.33](https://github.com/SonarSource/sonar-java/releases/tag/8.33.0.44481)
...
* Update IaC analyzer 2.10 -> [2.11](https://github.com/SonarSource/sonar-iac/releases/tag/2.11.0.21159)
...
* Update C# analyzer 10.21 -> [10.22](https://github.com/SonarSource/sonar-dotnet/releases/tag/10.22.0.136894) -> [10.23](https://github.com/SonarSource/sonar-dotnet/releases/tag/10.23.0.137933)
...
* Update Java analyzer 8.22 -> [8.23](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20%3D%2027248%20ORDER%20BY%20created%20ASC)
...
* Update Java analyzer 8.19 -> [8.20](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20%3D%2023492%20ORDER%20BY%20created%20ASC)
...
* Update IaC analyzer 1.48 -> [1.49](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20%3D%2021830%20ORDER%20BY%20created%20ASC)
...
* Update C# analyzer 10.12 -> [10.13](https://github.com/SonarSource/sonar-dotnet/releases/tag/10.13.0.120203) -> [10.14](https://github.com/SonarSource/sonar-dotnet/releases/tag/10.14.0.120626)
...
* Update JS/TS/CSS analyzer 10.24 -> [11.0](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20%3D%2020223%20ORDER%20BY%20created%20ASC)
...
* Update C# analyzer 10.11 -> [10.12](https://github.com/SonarSource/sonar-dotnet-enterprise/releases/tag/10.12.0.118525)
...
* Update Text analyzer 2.22 -> [2.23](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20%3D%2018013%20ORDER%20BY%20created%20ASC) -> [2.24](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20%3D%2019436%20ORDER%20BY%20created%20ASC)
...
* Update Python analyzer 5.2 -> [5.3](https://sonarsource.atlassian.net/issues/SONARPY-1219?jql=fixVersion%20%3D%2017788%20ORDER%20BY%20created%20ASC)
...
* Update Go analyzer 1.21.0 -> [1.21.1](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20=%2018182%20ORDER%20BY%20created%20ASC)
* Update C# analyzer 10.7 -> [10.8](https://github.com/SonarSource/sonar-dotnet-enterprise/releases/tag/10.8.0.113526)

## 4.19

* Update Go analyzer 1.20 -> [1.21](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20=%2017450%20ORDER%20BY%20created%20ASC)
* Update Java analyzer 8.10 -> [8.11](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20=%2016353%20ORDER%20BY%20created%20ASC)
* Update CFamily analyzer 6.64.1 -> [6.65](https://sonarsource.atlassian.net/issues/?jql=project%20=%2010166%20AND%20fixVersion=17285%20ORDER%20BY%20priority%20DESC,%20key%20ASC)
* Update Text analyzer 2.21.1 -> [2.22](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20=%2016663%20ORDER%20BY%20created%20ASC)
...
* Update PHP analyzer 3.40 -> [3.41](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20%3D%2016138%20ORDER%20BY%20created%20ASC) -> [3.42](https://sonarsource.atlassian.net/issues/?jql=fixVersion%20%3D%2016238%20ORDER%20BY%20created%20ASC)
...
* License change to the embedded analyzers. See [NOTICE.txt](https://github.com/SonarSource/sonarlint-vscode/blob/master/NOTICE.txt) for more details
...
* Update Java analyzer 7.34 -> [7.35](https://sonarsource.atlassian.net/issues/SONARJAVA-4951?jql=fixversion%20%3D%207.35%20ORDER%20BY%20created%20ASC) -> [8.0.1](https://sonarsource.atlassian.net/issues/SONARJAVA-5032?jql=fixversion%20%3D%208.0.1%20AND%20project%20%3D%20SONARJAVA%20ORDER%20BY%20created%20ASC) -> [8.1](https://sonarsource.atlassian.net/issues/SONARJAVA-5045?jql=project%20%3D%20SONARJAVA%20AND%20fixversion%20%3D%208.1%20ORDER%20BY%20created%20ASC), provide needed change to run Java Dataflow Bug Detection rules in SonarLint in Connected Mode, custom rules plugin around symbolic execution engine, 20 new rules enabled on test code
...
* Update JS/TS/CSS analyzer 10.12 -> [10.13](https://github.com/SonarSource/SonarJS/releases/tag/10.13.0.25911) -> [10.13.1](https://github.com/SonarSource/SonarJS/releases/tag/10.13.1.25965) -> [10.13.2](https://github.com/SonarSource/SonarJS/releases/tag/10.13.2.25981) -> [10.14](https://github.com/SonarSource/SonarJS/releases/tag/10.14.0.26080), new rules for accessibility, require Node 18, disable type checking for Vue.js, bug fixes and performance improvements
...
* Update embedded C# analyzer 9.12 -> [9.13](https://github.com/SonarSource/sonar-dotnet/releases/tag/9.13.0.79967), support for .NET 8 & C# 12, fixes and improvements
